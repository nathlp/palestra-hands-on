...
modelo = graphviz.Digraph(name='vmCloud', directory='modelos/') 
...
modelo.node('2', 'VM1', image='R1x1.gif', shape='plaintext', labelloc='t', comment=' 2 None 1 None 0.325 ') 
modelo.node('3', 'VM2', image='R1x1.gif', shape='plaintext', labelloc='t', comment=' 2 None 1 None 0.325 ')
modelo.node('4', 'VM3', image='R1x1.gif', shape='plaintext', labelloc='t', comment=' 2 None 1 None 0.325 ')
modelo.node('5', 'VM4', image='R1x1.gif', shape='plaintext', labelloc='t', comment=' 2 None 1 None 0.325 ')

modelo.node('6', 'Destination', image='REnd.gif', shape='plaintext', labelloc='t', comment='3')
...
modelo.edge('3', '6', comment='100')
modelo.edge('4', '6', comment='100')
modelo.edge('5', '6', comment='100')
